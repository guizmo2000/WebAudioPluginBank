...
var hosts = hosts || {};
hosts.FaustStereoFreqShifter = class StereoFreqShifter extends AudioWorkletNode {
...
faust.create = function(context, callback)
{
    ...
    context.audioWorklet.addModule("StereoFreqShifter-processor.js")
    .then(function () {
         callback(new StereoFreqShifter(context, {}));
    })
    .catch(function(error) { console.log(error); console.log("Faust StereoFreqShifter cannot be loaded or compiled"); });
}
