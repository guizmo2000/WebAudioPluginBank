...
class BlipperProcessor extends AudioWorkletProcessor {
    ...
    constructor(options)
    {
        ...
        this.factory = BlipperProcessor.Blipper_instance.exports;
        this.HEAP = BlipperProcessor.Blipper_instance.exports.memory.buffer;
...
try {
    let wasm_module = new WebAssembly.Module(BlipperProcessor.atob(getBase64CodeBlipper()));
    BlipperProcessor.Blipper_instance = new WebAssembly.Instance(wasm_module, BlipperProcessor.importObject);
