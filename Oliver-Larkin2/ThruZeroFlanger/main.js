...
load() {
    return new Promise((resolve, reject) => {
        ...
        this.context.audioWorklet.addModule(this.baseUrl + "/ThruZeroFlanger-processor.js").then(() => {
            this.plug = new ThruZeroFlangerNode(this.context, {});
            return (this.plug);
        }).then((faust) => {
