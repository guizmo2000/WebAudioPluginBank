...
class WeirdPhaserProcessor extends AudioWorkletProcessor {
    ...
    constructor(options)
    {
        ...
        this.factory = WeirdPhaserProcessor.WeirdPhaser_instance.exports;
        this.HEAP = WeirdPhaserProcessor.WeirdPhaser_instance.exports.memory.buffer;
...
try {
    let wasm_module = new WebAssembly.Module(WeirdPhaserProcessor.atob(getBase64CodeWeirdPhaser()));
    WeirdPhaserProcessor.WeirdPhaser_instance = new WebAssembly.Instance(wasm_module, WeirdPhaserProcessor.importObject);
