...
class DualPitchShifterProcessor extends AudioWorkletProcessor {
    ...
    constructor(options)
    {
        ...
        this.factory = DualPitchShifterProcessor.DualPitchShifter_instance.exports;
        this.HEAP = DualPitchShifterProcessor.DualPitchShifter_instance.exports.memory.buffer;
...
try {
    let wasm_module = new WebAssembly.Module(DualPitchShifterProcessor.atob(getBase64CodeDualPitchShifter()));
    DualPitchShifterProcessor.DualPitchShifter_instance = new WebAssembly.Instance(wasm_module, DualPitchShifterProcessor.importObject);
