...
var hosts = hosts || {};
hosts.FaustDualPitchShifter = class DualPitchShifter extends AudioWorkletNode {
...
faust.create = function(context, callback)
{
    ...
    context.audioWorklet.addModule("DualPitchShifter-processor.js")
    .then(function () {
         callback(new DualPitchShifter(context, {}));
    })
    .catch(function(error) { console.log(error); console.log("Faust DualPitchShifter cannot be loaded or compiled"); });
}
