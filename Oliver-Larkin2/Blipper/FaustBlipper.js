...
var hosts = hosts || {};
hosts.FaustBlipper = class Blipper extends AudioWorkletNode {
...
faust.create = function(context, callback)
{
    ...
    context.audioWorklet.addModule("Blipper-processor.js")
    .then(function () {
         callback(new Blipper(context, {}));
    })
    .catch(function(error) { console.log(error); console.log("Faust Blipper cannot be loaded or compiled"); });
}
