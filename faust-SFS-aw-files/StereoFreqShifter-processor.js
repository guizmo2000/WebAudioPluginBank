...
class StereoFreqShifterProcessor extends AudioWorkletProcessor {
    ...
    constructor(options)
    {
        ...
        this.factory = StereoFreqShifterProcessor.StereoFreqShifter_instance.exports;
        this.HEAP = StereoFreqShifterProcessor.StereoFreqShifter_instance.exports.memory.buffer;
...
try {
    let wasm_module = new WebAssembly.Module(StereoFreqShifterProcessor.atob(getBase64CodeStereoFreqShifter()));
    StereoFreqShifterProcessor.StereoFreqShifter_instance = new WebAssembly.Instance(wasm_module, StereoFreqShifterProcessor.importObject);
