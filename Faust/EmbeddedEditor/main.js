...
*/
window.EmbeddedEditor = class EmbeddedEditor extends WebAudioPluginCompositeNode {
...
window.WasabiEmbeddedEditor = class WasabiEmbeddedEditor extends WebAudioPluginFactory {
...
AudioContext.prototype.createWasabiEmbeddedEditorCompositeNode =
  OfflineAudioContext.prototype.createWasabiEmbeddedEditorCompositeNode = function (options) {
    return new EmbeddedEditor(this, options);
  };
