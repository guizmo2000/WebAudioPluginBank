...
class untitledProcessor extends AudioWorkletProcessor {
    ...
    static get parameterDescriptors () 
    {
        ...
        var params = [];
        untitledProcessor.parse_ui(JSON.parse(getJSONuntitled(/*
 faust2wasm: GRAME 2017-2018
*/
    ...
    constructor(options)
    {
        ...
        this.loadFile = function (sound_index, sound_ptr, length, sample_rate, channels, buffers)
        {
            ...
            */
            ...
            var start_of_)).ui, params, untitledProcessor.parse_item1);
        return params;
    }
    ...
    constructor(options)
    {
        ...
        this.initAux = function ()
        {
            ...
            */
            ...
            // Init DSP
            this.factory.init(this.dsp, sampleRate); // 'sampleRate' is defined in Audsoundfile_data_ptr = end_of_soundfile_ptr + this.ptr_size * channels;
