...
if (typeof (AudioWorkletNode) === "undefined") {
 ...
 hosts.FaustZitaRev = class zitaRev extends AudioWorkletNode {
...
hosts.loadZitaRev = function (context) {
    return new Promise(function (resolve, reject) {
        context.audioWorklet.addModule("https://wasabi.i3s.unice.fr/WebAudioPluginBank/Faust/ZitaRev/zitaRev-processor.js").then(function () {
            var plug = new hosts.FaustZitaRev(context, {}) ;
